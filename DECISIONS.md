...
- **D-2026-08-09-chapter-03-from-zuploads** — Pulled Chapter 3's prose and art in from the `zcold-data`
...
## D-2026-08-09-chapter-03-from-zuploads · source Chapter 3's prose and art from the zcold-data drop zone

- **Context:** The player said "chapter 3 art and story are now under z-uploads" — a folder on the
  separate `zcold-data` branch (not `main`), synced there by a background script on the player's own
...
- **Status:** Active. `chapter-03-draft-Autumn-Who-to-Believe.md` stays `draft: true` until the player
  ...
  out of the built site. The source file and images still exist on `zcold-data`'s `z-uploads/` — left
